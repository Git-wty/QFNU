...
<body>
	...
	<section class="class-main">
		...
		<div class="community-list">
			<%
				request.setCharacterEncoding("utf-8");
				String community_style = request.getParameter("community_style");
			%>
			<div style="font-size: 16px; font-weight: bold; margin-top: 5px;">
				<a href="iTeach-community.jsp">爱学社区</a>/<%=community_style%></div>
			...
			<sql:query dataSource="${question}" var="result">
	 			SELECT * from question WHERE question_style='<%=community_style%>';
			 </sql:query>

			<c:forEach var="row" items="${result.rows}">
				<div
					style="width: 700px; min-height: 200px; border: 3px solid #1E9FFF; margin-top: 5px; padding-top: 20px; padding-left: 20px;">
					<h2>
						<a
							href="question-view.jsp?question_id=<c:out value="${row.question_id}"/>"><c:out
								value="${row.question_name}" /></a>
					</h2>
					<div style="margin-top: 10px; height: 90px; width: 650px;">
