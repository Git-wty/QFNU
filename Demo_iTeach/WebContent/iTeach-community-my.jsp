	...
	<section class="class-main">
		...
		<div class="community-list">
			<nav class="navbar navbar-default class-topic" role="navigation"
				...
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">我的问题</a>
					</div>
					<div class="collapse navbar-collapse" id="example-navbar-collapse">
						<ul class="nav navbar-nav">
							<li><a href="iTeach-community.jsp">爱学社区</a></li>
							<li><a href="Insert_question.jsp">我要提问</a></li>
						</ul>
					</div>
				</div>
			</nav>
			<div style="font-size: 20px; font-weight: bold; margin-top: 5px;">我提出的问题</div>
			...
			<sql:query dataSource="${question}" var="result">
	 			SELECT * from question WHERE question_user='<%=username %>';
			 </sql:query>
