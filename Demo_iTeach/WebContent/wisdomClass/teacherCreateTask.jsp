	...
	<header class="container" style="width: 100%;">
		...
		<div class="header-line1">
			...
			<div class="header-user">
				<a href="../iTeach-myself.jsp"><%=studentName%></a>
			</div>
			...
			<form class="navbar-form  select hidden-xs " role="search">
				<div class="form-group">
					<input type="text" class="form-control" placeholder="输入你想要搜索的课程">
				</div>
	...
	<section class="class-main">
		...
		<div class="class-content">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="example-navbar-collapse">
						<ul class="nav navbar-nav">
							<li class="active"><a href="teacherShowClass.jsp">课堂管理</a></li>
			...
			<fieldset class="layui-elem-field layui-field-title"
				...
				<legend>作业发布中心</legend>
			</fieldset>
			<form action="../CreateTaskServlet" name="createtaskform">
				<div class="layui-form-item layui-form-text">

					<div class="layui-input-block" style="margin-left: 0px;">
						<textarea placeholder="请输入发布作业的要求" class="layui-textarea"
							name="task_require" style="font-size: 24px;"></textarea>
					</div>
				</div>
				<input type="hidden" name="class_id" value="<%=classId%>" />
				<button id="create_task" class="layui-btn" style="margin-left: 45%">创建作业</button>
			</form>
