		...
		<div class="class-content">
			...
			<div class="layui-form">
				<table class="layui-table">
					...
					<thead>
						<tr>
							<th><div class="table-title">评价/建议</div></th>
							<th><div class="table-title">发表学生</div></th>
						</tr>
					</thead>
					<tbody>
						...
						<sql:query dataSource="${teacher_class}" var="result">
	 					SELECT * from comment WHERE class_id='<%=class_id%>';
			 	</sql:query>
