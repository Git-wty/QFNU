	...
	<section class="class-main">
		...
		<div class="class-content">
			...
			<fieldset class="layui-elem-field layui-field-title"
				...
				<legend> 您在此班级内所发布的所有作业展示如下</legend>
			</fieldset>
			...
			<div class="layui-form">
				<table class="layui-table">
					...
					<thead>
						<tr>
							<th><div class="table-title">作业内容</div></th>
							<th><div class="table-title">发布日期</div></th>
						</tr>
					</thead>
					<tbody>
					...
					select * from task where class_id='<%=classId%>';
				</sql:query>

						<c:forEach var="row" items="${result.rows}">
							<tr>
								<td><c:out value="${row.task_require}"></c:out></td>
								<td><c:out value="${row.task_date}"></c:out></td>
			...
			<form action="teacherCreateTask.jsp" name="createtaskform">
				<input type="hidden" name="class_id" value="<%=classId%>" />
				<button id="create_task" class="layui-btn" style="margin-left: 45%">在该班级内发布新作业</button>
			</form>
