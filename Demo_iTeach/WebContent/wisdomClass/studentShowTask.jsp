		...
		<div class="class-content">
			...
			<div class="layui-form">
				<table class="layui-table">
					...
					<thead>
						<tr>
							<th><div class="table-title">作业要求</div></th>
							<th><div class="table-title">发布时间</div></th>
						</tr>
					</thead>
					<tbody>
						...
						<sql:query dataSource="${teacher_class}" var="result">
	 					SELECT * from task WHERE class_id='<%=class_id%>';
			 	</sql:query>
						<c:forEach var="row" items="${result.rows}">
							<tr>
								<td><c:out value="${row.task_require}" /></td>
								<td><c:out value="${row.task_date}" /></td>
							</tr>
